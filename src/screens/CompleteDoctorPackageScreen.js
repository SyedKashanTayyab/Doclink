...
class CompleteDoctorPackageScreen extends Component {
    constructor(props) {
        super(props);
        this.state = {
            refreshing: false,
    ...
    _addSubscription = async (package_amount, package_id, duration) => {
        ...
        try {
            ...
            if (data.status == "Success") {
                ...
                appHelper.toastMsg('No Data Found');
            }
        }
        catch (error) {
        ...
        return (
            <View style={{ flex: 1 }}>
                ...
                <View style={{ flex:1 }}>
                    ...
                    <Text style={styles.headingTitle}>Add Prices to Package</Text>
...
export default CompleteDoctorPackageScreen;
