...
class DropDownPicker extends React.Component {
    ...
    handlePlaceholder = () => {
        ...
        // console.log("break============================");
        // console.log("handlePlaceholder fired", choice);
        // console.log("break============================");
        this.setState({
            choice: {
                label: null,
